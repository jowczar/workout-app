class TextConstant {
  ...
  static const String forgotPasswordSignIn = "Forgot password?";
  static const String signInWithGoogleButton = "Sign in with Google";
  ...
  static const String addNewChallenge = "+";
