...
class Workout1Screen extends StatelessWidget {
  @override
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Container(
                    ...
                    padding:
                        getPadding(left: 32, top: 31, right: 32, bottom: 31),
                    child: Column(
  ...
  onTapTxtListOne(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.calendarWithActivityScreen);
  }
  ...
  onTapTxtListThree(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.calendarWithActivityScreen);
  }
